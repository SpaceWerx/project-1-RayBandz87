...
public class RoleDAO {
	public void updateSalary(String roleTitle, int newSalary) throws SQLException {
		try (Connection conn = ConnectionFactory.getConnection()) {
			...
			e.printStackTrace(); // What I usually do, is I will only leave these in, while I am testing and
									// building the code, and once everything works and I know it works, I remove
									// them
		}
	}
